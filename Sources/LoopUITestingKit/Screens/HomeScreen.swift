...
public final class HomeScreen: BaseScreen {
    ...
    public func noRecentGlucoseTextExists(timeout: Double, testCase: XCTestCase? = nil) -> Bool {
        testCase?.executionTimeAllowance = TimeInterval(timeout)
        return noRecentGlucoseText.waitForExistence(timeout: timeout)
    }
